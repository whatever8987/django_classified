...
class ItemCreateView(FormsetMixin, CreateView):
    ...
    model = Item
    form_class = ItemForm
    formset_class = inlineformset_factory(Item, Image, extra=5, fields=('file', ))
    ...
    def form_valid(self, form, formset):
        ...
        try:
            ...
            if str(e) == "Insufficient balance":
                return render(self.request, 'insufficient_fund.html')
            else:
                # Handle other exceptions or re-raise the ValueError
                raise e
...
class ProfileView(UpdateView):
    ...
    def form_valid(self, form):
        messages.success(self.request, _('Your profile settings were updated!'))
...
class InsufficientFundView(TemplateView):
    template_name = 'insufficient_fund.html'  # Assuming you have a template named 'insufficient_balance.html'
